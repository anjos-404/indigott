export default function Introduction(){
    return(
        <div className="md:mt-10">
            <h4 className="text-[40px] leading-normal">INSCREVA-SE</h4>
          <p>Bem-vindo ao Índigo, preencha o formulário abaixo para</p>
          <p className="leading-normal">completar sua inscrição e participar do evento.</p>
